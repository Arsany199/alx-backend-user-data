#!/usr/bin/env python3
"""model session authentication route handler"""
...
def session_login() -> str:
    """function return user instance 400 if missing"""
...
def session_logout() -> str:
    """function that returns deleted json if correctly done 404 if fails"""
    from api.v1.app import auth
